...
def juno_lesia_calibrated_to_cdf(filename, output_path="../../data_n2/spdyn_cdf_data_calibrated/", verbose=False):
	result0=readsav("/Users/serpe/Volumes/kronos/juno/calibration/gain/gain_final_lin.sav")
	gain=result0['gain_final'].copy()
	result1=readsav("/Users/serpe/Volumes/kronos/juno/calibration/background/background_ALLPJ_zlin.sav")
	...
	# to be changed - doi of the paper
	cdf.attrs['VESPA_bib_reference'] = '...'
	...
	cdf['Gain'].attrs.new('VALIDMIN', data=0.1, type=pycdf.const.CDF_REAL4) 
	cdf['Gain'].attrs.new('VALIDMAX', data=800, type=pycdf.const.CDF_REAL4) 
	cdf['Gain'].attrs['VAR_TYPE'] = "support_data"
	cdf['Gain'].attrs['SCALETYP'] = "log"
	cdf['Gain'].attrs.new('SCALEMIN', data=0.1, type=pycdf.const.CDF_REAL4)
	...
	cdf['Background'].attrs.new('VALIDMAX', data=1e-10, type=pycdf.const.CDF_REAL4) 
	...
	cdf['Background'].attrs.new('SCALEMAX', data=1e-11, type=pycdf.const.CDF_REAL4)
	...
	cdf['Sigma'].attrs.new('VALIDMAX', data=1e-9, type=pycdf.const.CDF_REAL4) 
	...
	cdf['Sigma'].attrs.new('SCALEMAX', data=1e-10, type=pycdf.const.CDF_REAL4)
...
if __name__ == "__main__":
	...
	parser.add_argument('--o', dest='output_path', type=str, default="../../data_n2/spdyn_cdf_data_calibrated/", help="CDF savefile output path")
	parser.add_argument('-v', dest='verbose', help="Verbose flag", action='store_true')
	args = parser.parse_args()
	if os.path.exists(args.input_path):
		juno_lesia_calibrated_to_cdf(args.input_path, args.output_path, verbose=args.verbose)
		print(f"The cdf file has been produced")
	else:
